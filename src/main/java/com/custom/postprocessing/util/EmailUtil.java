 ...
 *//**
	 ...
	 *//*
		 ...
		 * String body) { try { MimeMessage msg = new MimeMessage(session); // set
		 ...
		 * "8bit");
		 * 
		 * msg.setFrom(new InternetAddress("swainkumar10@gmail.com", "NoReply-JD"));
		 * 
		 * msg.setReplyTo(InternetAddress.parse("kumarswain367@gmail.com", false));
		 * 
